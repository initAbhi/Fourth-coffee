...
interface CoffeePouringScreenProps {
  onComplete: () => void;
}

export function CoffeePouringScreen({ onComplete }: CoffeePouringScreenProps) {
  ...
  useEffect(() => {
    ...
    // Fallback timeout in case video doesn't end properly
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        <video
          ...
          preload="auto"
        >
          <source src="/cofeepouring.mp4" type="video/mp4" />
        </video>
